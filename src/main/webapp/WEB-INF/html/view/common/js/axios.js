...
!function (e, t) {
    "object" == typeof exports && "object" == typeof module
        ...
        ? define([], t) : "object" == typeof exports ? exports.axios = t()
            : e.axios = t()
}(this, function () {
    return function (e) {
        function t(r) {
            ...
            return e[r].call(o.exports, o, o.exports,
                t), o.loaded = !0, o.exports
        }
        ...
        function v(e, t) {
            if (null !== e && "undefined" != typeof e) {
                ...
                && (e = [e]), r(e)) {
                    ...
                    for (var i in
                        e) {
                        Object.prototype.hasOwnProperty.call(e, i) && t.call(
                            null,
                            e[i], i, e)
                    }
                }
        ...
        r.prototype.request = function (e) {
            "string" == typeof e && (e = i.merge({url: arguments[0]},
                arguments[1])), e = i.merge(o, {method: "get"}, this.defaults,
        ...
        function o() {
            var e;
            return "undefined" != typeof XMLHttpRequest ? e = n(8) : "undefined"
                != typeof process && (e = n(8)), e
        }

        var i = n(2), s = n(7),
            u = {"Content-Type": "application/x-www-form-urlencoded"}, a = {
                adapter: o(),
                transformRequest: [function (e, t) {
                    return s(t, "Content-Type"), i.isFormData(e) || i.isArrayBuffer(
                        e) || i.isBuffer(e) || i.isStream(e) || i.isFile(e)
                    || i.isBlob(e) ? e : i.isArrayBufferView(e) ? e.buffer
                        : i.isURLSearchParams(e) ? (r(t,
        ...
        a.headers = {common: {Accept: "application/json, text/plain, */*"}}, i.forEach(
        ...
        e.exports = function (e) {
            return new Promise(function (t, f) {
                ...
                if ("setRequestHeader" in l && r.forEach(d, function (e, t) {
                    "undefined" == typeof p && "content-type"
                    === t.toLowerCase() ? delete d[t] : l.setRequestHeader(t, e)
                }), e.withCredentials
                && (l.withCredentials = !0), e.responseType) {
                    try {
                ...
                == typeof e.onUploadProgress && l.upload
        ...
        e.exports = function (e) {
            ...
            return e ? (r.forEach(e.split("\n"), function (e) {
                if (i = e.indexOf(":"), t = r.trim(
                    e.substr(0, i)).toLowerCase(), n = r.trim(
                    e.substr(i + 1)), t) {
                    if (s[t] && o.indexOf(t) >= 0) {
                        return;
                    }
                    "set-cookie" === t ? s[t] = (s[t] ? s[t] : []).concat([n])
                        : s[t] = s[t] ? s[t] + ", " + n : n
                }
            }), s) : s
        }
        ...
        e.exports = r.isStandardBrowserEnv() ? function () {
            function e(e) {
                var t = e;
                return n && (o.setAttribute("href",
                    t), t = o.href), o.setAttribute("href", t), {
                    href: o.href,
        ...
        function r(e) {
            for (var t, r, i = String(e), s = "", u = 0, a = o;
                i.charAt(0 | u) || (a = "=", u % 1);
        ...
        e.exports = r.isStandardBrowserEnv() ? function () {
            return {
                write: function (e, t, n, o, i, s) {
                    ...
                    && u.push("expires=" + new Date(
                        n).toGMTString()), r.isString(o) && u.push("path="
                        + o), r.isString(i) && u.push("domain=" + i), s === !0
        ...
        e.exports = function (e) {
            r(e), e.baseURL && !a(e.url) && (e.url = c(e.baseURL,
            ...
            return t(e).then(function (t) {
                return r(e), t.data = i(t.data, t.headers,
                    e.transformResponse), t
            }, function (t) {
                return s(t) || (r(e), t && t.response && (t.response.data = i(
