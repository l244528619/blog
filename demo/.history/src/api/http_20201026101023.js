...
request.interceptors.request.use((config) => {
    ...
    //store需要安装、引入
    if(window.sessionStorage.getItem('headertoken')){
        config.header.headertoken = window.sessionStorage.getItem('headertoken')
    }
    console.log(config, "cccccccccccc",window.sessionStorage.getItem('headertoken'));
