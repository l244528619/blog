    ...
    <header>
      ...
      <div class="headerNav">
        <el-row>
          ...
          <el-button v-show="logiout" type="text" @click="logins">登录</el-button>

          <el-button type="text" v-show="signIn">{{ admin }},你好</el-button>
          <el-button type="text" v-show="signIn" @click="signOut">退出</el-button>
        </el-row>
      </div>
    </header>
