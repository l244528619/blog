    ...
    <header>
      ...
      <div class="headerNav">
        <el-row>
          ...
          <el-button type="text" v-if="signIn">XXX,你好</el-button>
          <el-button type="text" v-if="signIn">退出</el-button>
        </el-row>
      </div>
    </header>
    ...
    login() {
      this.$refs.ruleForm.validate(async (valid) => {
        ...
        if (valid && flag) {
          ...
          // this.getlogin();
          this.$store.commit('headerSet',msg) 
          console.log("成功11111111", this.flag,msg,this.ruleForm.userName, this.homeSet(this.ruleForm.userName));
