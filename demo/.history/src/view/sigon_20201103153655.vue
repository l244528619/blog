    ...
    <nav class="navBackground">
      ...
      <div class="navText">
        <div class="navwriting">
          ...
          <span style="font-size: 14px; padding-bottom: 25px"
            >已有账号？<el-button
              style="padding: 0"
              type="text"
              @click="goIndex"
            ...
            <el-form-item label="验证码" prop="code">
              <div class="btnCode">
                <el-input
                  ...
                  placeholder="请输入验证码"
                ></el-input>
                  <el-image class="imageSign" width="300" :src="url" fit="contain"></el-image>
              </div>
            </el-form-item>
            <el-form-item
              class="goIndex"
...
export default {
  ...
  data() {
    ...
    return {
      ...
      url: "http://47.98.226.42/captcha/getCaptcha", //验证码
      ruleForm: {
        user: "",
        pass: "",
        checkPass: "",
