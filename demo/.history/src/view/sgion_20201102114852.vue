      ...
      <div class="navText">
        <div class="navwriting">
          ...
          >
            ...
            <el-form-item class="goIndex" style="margin-left: -100px;margin-right: -100px; width: 100%">
              <el-button type="primary"  style="margin-right: 100px; width: 100%" @click="submitForm('ruleForm')"
                >注册</el-button
              >
