    ...
    <nav class="navBackground">
      ...
      <div class="navText">
        <div class="navwriting">
          ...
          <span style="font-size:14px;padding-bottom:25px">已有账号？<el-button  style="padding:0" type="text" @click="goIndex">登录</el-button>
          </span>
          <el-form
            label-position="left"
            :model="ruleForm"
          ...
          >
            ...
            <el-form-item
              class="goIndex"
              style="margin-left: -100px; margin-right: -100px; width: 100%"
            >
...
export default {
  ...
  methods: {
    submitForm(formName) {
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
         ...
         let coo = await this.$api.liveApi.getSaveUser({
    ...
    async verificationCode() {
      this.image = await this.$api.liveApi.getVerification();
      // console.log(coo);
    },
  },
  created() {},
