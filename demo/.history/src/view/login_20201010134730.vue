  ...
  methods: {
    login() {
      this.$refs.ruleForm.validate( async valid => {
        if (valid) {
          // this.getLogin(this.ruleForm.userName, this.ruleForm.password);
           let {msg,flag} =  await this.$api.liveApi.getLogin({ userName: this.ruleForm.userName, password: this.ruleForm.password })
            if(!flag){
       console.log(msg)
     }
   ...
   async getLogin(userName, password) {
    //  let {msg,flag} =  await this.$api.liveApi.getLogin({ userName: userName, password: password })
    //  console.log(msg)
     if(!flag){
       console.log(msg)
     }
